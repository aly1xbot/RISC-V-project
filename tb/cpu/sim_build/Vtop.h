...
class alignas(VL_CACHE_LINE_BYTES) Vtop VL_NOT_FINAL : public VerilatedModel {
  ...
  public:
    ...
    Vtop_instruction_set_pkg* const __PVT__instruction_set_pkg;
    Vtop_axi_if* const __PVT__cpu_test_harness__DOT__m_axi;
    Vtop_axi_if* const __PVT__cpu_test_harness__DOT__core__DOT__m_axi_data;
    Vtop_axi_if* const __PVT__cpu_test_harness__DOT__core__DOT__m_axi_inst;
