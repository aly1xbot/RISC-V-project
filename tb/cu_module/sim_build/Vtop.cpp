...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , alu_last_bit{vlSymsp->TOP.alu_last_bit}
    , alu_unsigned_less{vlSymsp->TOP.alu_unsigned_less}
    , alu_control{vlSymsp->TOP.alu_control}
    , imm_source{vlSymsp->TOP.imm_source}
    , reg_write{vlSymsp->TOP.reg_write}
    , mem_write{vlSymsp->TOP.mem_write}
    , alu_source{vlSymsp->TOP.alu_source}
    , write_back_source{vlSymsp->TOP.write_back_source}
    , pc_source{vlSymsp->TOP.pc_source}
    , second_add_source{vlSymsp->TOP.second_add_source}
    , mem_read{vlSymsp->TOP.mem_read}
    , fence{vlSymsp->TOP.fence}
    , fence_i{vlSymsp->TOP.fence_i}
    , trap_valid{vlSymsp->TOP.trap_valid}
    , trap_cause{vlSymsp->TOP.trap_cause}
    , system_imm{vlSymsp->TOP.system_imm}
    , __PVT__instruction_set_pkg{vlSymsp->TOP.__PVT__instruction_set_pkg}
    , rootp{&(vlSymsp->TOP)}
{
