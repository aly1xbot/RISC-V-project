...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final {
  public:
    ...
    struct {
        ...
        CData/*2:0*/ cpu__DOT__alu_control;
        CData/*1:0*/ cpu__DOT__imm_source;
        CData/*0:0*/ cpu__DOT__reg_write;
        CData/*0:0*/ cpu__DOT__mem_write;
        CData/*0:0*/ cpu__DOT__alu_source;
        CData/*0:0*/ cpu__DOT__write_back_source;
        ...
        CData/*6:0*/ cpu__DOT__control__DOT__op;
        CData/*2:0*/ cpu__DOT__control__DOT__func3;
        CData/*6:0*/ cpu__DOT__control__DOT__func7;
        CData/*0:0*/ cpu__DOT__control__DOT__alu_zero;
        CData/*2:0*/ cpu__DOT__control__DOT__alu_control;
        CData/*1:0*/ cpu__DOT__control__DOT__imm_source;
        CData/*0:0*/ cpu__DOT__control__DOT__reg_write;
        CData/*0:0*/ cpu__DOT__control__DOT__mem_write;
        CData/*0:0*/ cpu__DOT__control__DOT__alu_source;
        CData/*0:0*/ cpu__DOT__control__DOT__write_back_source;
        CData/*0:0*/ cpu__DOT__control__DOT__pc_source;
        CData/*1:0*/ cpu__DOT__control__DOT__alu_op;
        ...
        CData/*1:0*/ cpu__DOT__sign_extender__DOT__imm_source;
        CData/*2:0*/ cpu__DOT__alu_inst__DOT__alu_control;
        ...
        CData/*2:0*/ __Vtrigprevexpr___TOP__cpu__DOT__alu_inst__DOT__alu_control__0;
        ...
        CData/*2:0*/ __Vtrigprevexpr___TOP__cpu__DOT__alu_inst__DOT__alu_control__1;
        ...
        SData/*11:0*/ cpu__DOT__sign_extender__DOT__gathered_imm;
