...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , __PVT__cpu_test_harness__DOT__m_axi{vlSymsp->TOP.__PVT__cpu_test_harness__DOT__m_axi}
    , __PVT__cpu_test_harness__DOT__core__DOT__m_axi_data{vlSymsp->TOP.__PVT__cpu_test_harness__DOT__core__DOT__m_axi_data}
    , __PVT__cpu_test_harness__DOT__core__DOT__m_axi_inst{vlSymsp->TOP.__PVT__cpu_test_harness__DOT__core__DOT__m_axi_inst}
    , rootp{&(vlSymsp->TOP)}
{
